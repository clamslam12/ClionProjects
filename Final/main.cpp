...
private:
    ...
    node* root;
   node* insert(int y, string a, int w,string n, string f, node* t)///regular insert for add record
    {
        if(t == NULL)
        {
            t = new node;
    ...
    node* insert2(string n,int y1, string f1,int w1, string a1,node* t)///inserting for modifying fields
    {
        if(t == NULL)
        {
            t = new node;
...
public:
    ...
    void insert2(string n,int y1,string f1, int w1,string a1)
    {
