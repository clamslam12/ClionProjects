                ...
                if (option == 5) {
                    ...
                    while (sub_op3 != 6)
                    {
                        ...
                        if (sub_op3 == 4) {
                            ...
                            cout << "Complete search by winner(Enter 1 for winners and 0 for non-winners): " << endl;
                            int w0;
                            cin >> w0;
                ...
                if (option == 6)
                {
                    ...
                    while (sub_op4 != 6) {
                        ...
                        if (sub_op4 == 3) {
                            ...
                            cout << "Partial search by Award(Enter Award): " << endl;
                            string a0;
                            cin.ignore();
                            getline(cin, a0);
                            convertToUpper(a0);
                        ...
                        if (sub_op4 == 4) {
                            ...
                            cout << "Partial search by Winner(Enter Winner): " << endl;
                            string w0;
                            cin.ignore();
                            getline(cin, w0);
                        ...
                        if (sub_op4 == 5) {
                            ...
                            cout << "Partial search by Film(Enter Film): " << endl;
                            string f0;
                            cin.ignore();
                            getline(cin, f0);
                            convertToUpper(f0);
...
//below code for removing the space in the leading position of the "name" column in the csv file if there is
                        ...
                        a.insertByName(name, year1, nominations1, rating1, duration1, genre1, genre2, release, metacritic1, synopsis);
                        b.insertByName(name, year1, nominations1, rating1, duration1, genre1, genre2, release, metacritic1, synopsis);
                        c.insertByYear(name, year1, nominations1, rating1, duration1, genre1, genre2, release, metacritic1, synopsis);
                        d.insertByNominations(name, year1, nominations1, rating1, duration1, genre1, genre2, release, metacritic1, synopsis);
                        e.insertByRating(name, year1, nominations1, rating1, duration1, genre1, genre2, release, metacritic1, synopsis);
                        f.insertByDuration(name, year1, nominations1, rating1, duration1, genre1, genre2, release, metacritic1, synopsis);
                        g.insertByGenre1(name, year1, nominations1, rating1, duration1, genre1, genre2, release, metacritic1, synopsis);
                        h.insertByGenre2(name, year1, nominations1, rating1, duration1, genre1, genre2, release, metacritic1, synopsis);
                        i.insertByRelease(name, year1, nominations1, rating1, duration1, genre1, genre2, release, metacritic1, synopsis);
                        j.insertByMetacritic(name, year1, nominations1, rating1, duration1, genre1, genre2, release, metacritic1, synopsis);
                        k.insertBySynopsis(name, year1, nominations1, rating1, duration1, genre1, genre2, release, metacritic1, synopsis);

                        cout<<"\n Name: " << name << " Year: " << year1 << " Nominations: " << nominations1 << " Rating: " << rating1 << " Duration: " << duration1 << " Genre1: " << genre1 << " Genre2: " << genre2 << " Release: " << release << " Metacritic: " << metacritic1 << " Synopsis: " << synopsis << endl;
